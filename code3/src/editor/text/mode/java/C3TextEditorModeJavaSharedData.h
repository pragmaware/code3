#ifndef _C3TextEditorModeJavaSharedData_h_
#define _C3TextEditorModeJavaSharedData_h_
//=============================================================================
//
//   File : C3TextEditorModeJavaSharedData.h
...
class C3TextEditorModeJavaSharedData : public QObject
{
	Q_OBJECT
public:
	C3TextEditorModeJavaSharedData(C3TextEditorFactory * pFactory);
	~C3TextEditorModeJavaSharedData();
...
#endif //!_C3TextEditorModeJavaSharedData_h_