#ifndef _C3TextEditorModeASMSharedData_h_
#define _C3TextEditorModeASMSharedData_h_
//=============================================================================
//
//   File : C3TextEditorModeASMSharedData.h
...
class C3TextEditorModeASMSharedData : public QObject
{
	Q_OBJECT
public:
	C3TextEditorModeASMSharedData(C3TextEditorFactory * pFactory);
	~C3TextEditorModeASMSharedData();
...
#endif //!_C3TextEditorModeASMSharedData_h_