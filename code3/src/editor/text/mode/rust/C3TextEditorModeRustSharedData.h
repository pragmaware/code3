#ifndef _C3TextEditorModeRustSharedData_h_
#define _C3TextEditorModeRustSharedData_h_
//=============================================================================
//
//   File : C3TextEditorModeRustSharedData.h
...
class C3TextEditorModeRustSharedData : public QObject
{
	Q_OBJECT
public:
	C3TextEditorModeRustSharedData(C3TextEditorFactory * pFactory);
	~C3TextEditorModeRustSharedData();
...
#endif //!_C3TextEditorModeRustSharedData_h_